...
class night():
    ...
    def plot_paths(self, targets = None, priorities = None, moon = True, lunar_distance = False, angle_limits = True, figsize = (15,10), title = None, angle_ax = False):
        ...
        #Plotting moon trace
        if moon:
            fig.add_trace(go.Scatter(x=self.utc, y=self.lunar_path, mode = 'lines', name = 'Moon', line = dict(color = 'black', dash = 'dot')))
        ...
        fig.add_trace(go.Scatter(x=[self.utc[0], functions.era_to_utc(self.twilights[0][0])], y=[0, 0], line = dict(color = 'black'), fill='tonexty', fillcolor='rgba(0, 0, 0, 0.2)', showlegend=False, mode = 'lines'))
        ...
        fig.add_trace(go.Scatter(x=[self.utc[0], functions.era_to_utc(self.twilights[1][0])], y=[0, 0], line = dict(color = 'black'), fill='tonexty', fillcolor='rgba(0, 0, 0, 0.2)', showlegend=False, mode = 'lines'))
        ...
        fig.add_trace(go.Scatter(x=[self.utc[0], functions.era_to_utc(self.twilights[2][0])], y=[0, 0], line = dict(color = 'black'), fill='tonexty', fillcolor='rgba(0, 0, 0, 0.2)', showlegend=False, mode = 'lines'))
        ...
        fig.add_trace(go.Scatter(x=[functions.era_to_utc(self.twilights[0][1]), self.utc[-1]], y=[0, 0], line = dict(color = 'black'), fill='tonexty', fillcolor='rgba(0, 0, 0, 0.2)', showlegend=False, mode = 'lines', name = 'Astronomical sunrise'))
        ...
        fig.add_trace(go.Scatter(x=[functions.era_to_utc(self.twilights[1][1]), self.utc[-1]], y=[0, 0], line = dict(color = 'black'), fill='tonexty', fillcolor='rgba(0, 0, 0, 0.2)', showlegend=False, mode = 'lines', name = 'Nautical sunrise'))
        ...
        fig.add_trace(go.Scatter(x=[functions.era_to_utc(self.twilights[2][1]), self.utc[-1]], y=[0, 0], line = dict(color = 'black'), fill='tonexty', fillcolor='rgba(0, 0, 0, 0.2)', showlegend=False, mode = 'lines', name = 'Civil sunrise'))
        
        fig.show()

    #Plot the derived queue
    def plot_queue(self, moon = False, moon_distance = False, angle_limits = True, figsize = (15,10), title = None, angle_ax = False, priority_colours = {1:'#1ABC9C', 2:'#FFB900', 3:'#FF9600', 4:'#D62727'}):
        fig = go.Figure()
        ...
        for name in self.queue.index:
            if '__gap' not in name:
                ...
                fig.add_trace(go.Scatter(x=self.utc, y=self.paths[name], mode = 'lines', name = name, line = dict(color = 'rgba(0, 0, 0, 0.1)'), showlegend = False))
